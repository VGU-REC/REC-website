  ...
  return (
    <div>
      ...
      <div className="text-center text-lg container">
        ...
        sint. Velit officia consequatAmet minim mollit non deserunt ullamco est
        sit aliqua dolor do amet sint. Velit officia consequat.Amet minim mollit
      ...
      <div className="grid grid-cols-3 p-3">
        ...
        <div className="">
          <img src="test.jpg" className="w-80 mb-4 mx-auto" alt="Avatar" />
        </div>
      ...
      <h4 className="font-medium leading-tight text-3xl mt-0 mb-2 text-center">
        Head members
      </h4>
