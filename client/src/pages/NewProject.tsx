    ...
    <div className="m-3">
      <div className="flex justify-center">
        <div className="bg-gray-100 p-3">
          <form>
            <h1 className="pt-3 pb-3 text-2xl text-center">RECRUIT FORM</h1>
            <h4 className="container text-center p-3">
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="grid grid-cols-1 w-96 p-3">
              ...
              <div className="grid grid-cols-1 w-96 p-3">
                ...
                <textarea className="border border-black px-2 py-10" />
              </div>
              <div className="grid grid-cols-1 w-96 p-3">
                <label className="px-2">
              ...
              <div className="flex flex-row p-3 w-96">
              ...
              <div className="w-96 pt-2">
                <button className="bg-black border-black text-white w-full py-3">
                  Submit
                </button>
              </div>
            </div>
