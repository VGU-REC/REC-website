      ...
      <div className="grid grid-cols-1 divide-black divide-y-4">
        ...
        <div>
          <div className='grid grid-cols-2'>
            ...
            <Card image='img7.jpg' alt='Image' headline='Headline' description='This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.'/>
            </div>
          </div>
            ...
            <div className='h-96 flex justify-center mt-3'>
              <div className="pl-3">
                ...
                <div className="p-6 flex flex-col justify-start bg-white">
                  <h5 className="text-gray-900 text-xl font-medium">Headline</h5>
                  <p className="text-gray-700 text-base mb-4">Some quick example text to build on the card title and make up the bulk of the card'scontent.</p>
                </div>
              </div>
            </div>
            <div className='mt-3'>
              <Card image='img9.jpg' alt='Image' headline='Headline' description='This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.'/>
              <Card image='img10.jpg' alt='Image' headline='Headline' description='This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.'/>
            </div>
          </div>
        </div>
      </div>
